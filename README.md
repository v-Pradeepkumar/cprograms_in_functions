...
// rpogram to find the maximum and minimum element in any array
#include <stdio.h>
...
// what was the o/p error--> assignment of read-only location '*p'
#include <stdio.h>
...
// finding smallest and largest number in array using pointer
#include <stdio.h>
void minMax(int arr[] ,int len ,int *min ,int *max)
{
*min = *max = arr[0] ;
...
int main() {
    ...
    int len = sizeof(a)/sizeof(a[0]) ;
    minMax(a, len, &min,&max) ;
    printf("minimum of the value in the array is: %d and maximum of value in the array is: %d" ,min , max);
...
// compare different pointers using relational operator must rule is two pointers should pointing same array
#include <stdio.h>
...
//finding sum of array elements o/p sum is 76
#include <stdio.h>
...
// passing array as an argument to a function of sum of array elements
#include <stdio.h>
...
// find the o/p >>a = 6, b = 3,a = 15, b = 12 
#include <stdio.h>
